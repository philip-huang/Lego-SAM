...
BAG_PATH = "/home/mfi/repos/ros1_ws/src/philip/data/lego_6e6d49e7_trial_2_789_2025-08-08-14-59-00.bag"  # path to your bag file
TASK = "6e6d49e7_trial_2_789"
depth = False
...
OUTPUT_FREQ = 5  # Hz (i.e. one image every 1 seconds)
SYNC_TOLERANCE = rospy.Duration(0.2)  # seconds
...
def main():
    ...
    if depth:
        ...
        buffers = [buffer1, buffer2, step_buffer]
    ...
    if depth:
        ...
        topics = [TOPIC1, TOPIC2, TOPIC_STEP]
